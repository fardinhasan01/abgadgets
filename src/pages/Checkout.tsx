      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="bg-white/90 backdrop-blur-xl border border-orange-200/50">
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label htmlFor="phone" className="text-orange-700">Phone</Label>
                    <Input
                      id="phone"
                      name="phone"
                ...
                <div>
                  <Label htmlFor="deliveryArea" className="text-orange-700">Delivery Area</Label>
                  <Input
                    id="deliveryArea"
                    name="deliveryArea"
              ...
              <CardContent>
                <RadioGroup value={formData.paymentMethod} onValueChange={handlePaymentMethodChange}>
                  <div className="flex items-center space-x-2 mb-4">
                    ...
                    <Label htmlFor="cod" className="text-orange-700">Cash on Delivery</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="bkash" id="bkash" />
                    <Label htmlFor="bkash" className="text-orange-700">bKash</Label>
                  </div>
                </RadioGroup>
                
                {formData.paymentMethod === 'bkash' && (
                  <div className="mt-4">
                    <Label htmlFor="bkashNumber" className="text-orange-700">bKash Number</Label>
                    <Input
                      id="bkashNumber"
                      name="bkashNumber"
